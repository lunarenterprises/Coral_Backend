...
module.exports.updatePaymentStatus = async (investment_id, status) => {
    let Query = `update user_invest set ui_payment_status=?, ui_payment_type=? where ui_id=? `
...
module.exports.UploadPaymentReceipt = async (investment_id, filePath) => {
    let Query = `update user_invest set ui_payment_receipt=? , ui_payment_type=? where ui_id=? `
